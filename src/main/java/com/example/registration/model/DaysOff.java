...
public class DaysOff {
    ...
    public DaysOff(daysOffDto dto) {
        ...
        this.startDate = LocalDate.parse(dto.getStartYear()+"-"+dto.getStartMonth()+"-"+dto.getStartDay());
        this.endDate = LocalDate.parse(dto.getEndYear()+"-"+dto.getEndMonth()+"-"+dto.getEndDay());
